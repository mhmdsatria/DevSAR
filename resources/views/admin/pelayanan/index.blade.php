...
<div class="container mx-auto px-4 py-6 sm:px-6 lg:px-8">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Daftar Pelayanan</h1>
        ...
        <table class="min-w-full table-auto border border-gray-200 dark:border-gray-700">
            <thead class="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200">
                <tr>
                    ...
                    <th class="px-3 py-2 sm:px-4 sm:py-3 border-b border-gray-200 dark:border-gray-600 text-left text-xs sm:text-sm">Nama Pelayanan</th>
                    <th class="px-3 py-2 sm:px-4 sm:py-3 border-b border-gray-200 dark:border-gray-600 text-left text-xs sm:text-sm">Deskripsi</th>
            ...
            <tbody class="text-gray-700 dark:text-gray-300">
                @forelse ($pelayanans as $key => $data)
                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-3 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm font-medium">{{ $data->title }}</td>
